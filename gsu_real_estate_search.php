...
<body>
    <h1>Real Estate Buyer Property Search Page</h1>
    <BR><BR><BR><a href='http://localhost:8888/realestate_search_page.php'>Real Estate NonMember Search Page (NO SIGN-IN required)</a><BR><BR>
            
    <form action="gsu_login.php" method="post">
        <input type="text" id="emailid" name="emailid" placeholder="Email ID">
        <input type="text" id="pwd" name="pwd" placeholder="Password">
        <input type="submit" value="Login">
    </form>
    <form action="gsu_buyers_dashboard.php" method="post">
